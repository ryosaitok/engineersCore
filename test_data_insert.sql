...
-- BOOK_AUTHORデータ
INSERT INTO engineers_core_api_bookauthor (id, created_at, updated_at, author_id, book_id)
...
-- AMAZON_BOOKデータ
INSERT INTO engineers_core_api_amazonbook (id, data_asin, created_at, updated_at, book_id)
...
-- BOOK_DETAILデータ
INSERT INTO engineers_core_api_bookdetail (id, summary, created_at, updated_at, book_id)
...
-- BOOK_COMMENTデータ
INSERT INTO engineers_core_api_bookcomment (id, comment_text, comment_date, tweet_flag, delete_flag, created_at, updated_at, book_id, user_id)
...
-- COMMENT_FAVORITEデータ
INSERT INTO engineers_core_api_commentfavorite (id, favorite_date, delete_flag, created_at, updated_at, comment_id, user_id)
...
-- READ_BOOKデータ
INSERT INTO engineers_core_api_readbook (id, read_date, delete_flag, created_at, updated_at, book_id, user_id)
  VALUES (1, CURRENT_DATE(), FALSE, now(), now(), 1, 1);
INSERT INTO engineers_core_api_readbook (id, read_date, delete_flag, created_at, updated_at, book_id, user_id)
...
-- INTERESTED_BOOKデータ
INSERT INTO engineers_core_api_interestedbook (id, interested_date, delete_flag, created_at, updated_at, book_id, user_id)
